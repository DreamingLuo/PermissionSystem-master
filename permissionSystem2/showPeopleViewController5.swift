...
class showPeopleViewController5: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func getData(page:Int)
    {
        ...
        let URLstring1=String(format: "http://10.10.10.201/doc/Main/ListDoc_Mobile/?rows=8&page=%d&userId=guowen&sort=create_date&order=desc&fk_bizId=c_gDoc&fk_id=60CD3A28-607E-43D0-900B-821457685CE0&sk=phiic",page)
