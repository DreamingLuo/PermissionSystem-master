...
class mainViewController: UIViewController {
    ...
    // 首页中间的主要视图的来源
    var homeViewController=RootViewController()
    // 侧滑菜单视图的来源
   ...
   // var searchVC=searchViewController()
    ...
    override func viewDidLoad() {
      ...
      //  mainView.addSubview(tabBarView)
       ...
       homeNavigationController = UIStoryboard(name: "Main", bundle: nil).instantiateViewControllerWithIdentifier("RootNavigationController") as! UINavigationController
        ...
        homeViewController = homeNavigationController.viewControllers.first as! RootViewController
      ...
      //  let searchButton=UIBarButtonItem(title: "搜索", style: UIBarButtonItemStyle.Plain, target: self, action: "search")
        
       // let leftView=UIBarButtonItem(title:"左边",style: UIBarButtonItemStyle.Plain,target: self,action: "showLeft" )
        
        
        
        let img=UIImage(named: "slide")
        
        let item3=UIBarButtonItem(image: img, style: UIBarButtonItemStyle.Plain, target: self, action: "showLeft")
       // self.navigationItem.rightBarButtonItem=item3

        //let leftView=UIBarButtonItem(title: "左边", style: UIBarButtonItemStyle.Plain, target: self, action: "showLeft")
        
        homeViewController.navigationItem.leftBarButtonItem=item3
        
       // self.navigationItem.leftBarButtonItem=UIBarButtonItem(title: "左边", style: UIBarButtonItemStyle.Plain, target: self, action: "showLeft")
        
        homeViewController.title="我的文库"
        
          homeNavigationController.navigationBar.titleTextAttributes =
            [NSForegroundColorAttributeName: UIColor.whiteColor()]
        
         homeNavigationController.navigationBar.tintColor = UIColor.whiteColor()
        //self.navigationItem.title="文档管理系统"
        
       // homeViewController.navigationItem.rightBarButtonItems=[searchButton]
