...
class showPeopleViewController4: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func getData(page:Int)
    {
        ...
        let URLstring1=String(format: "http://10.10.10.201/doc/Main/ListDoc_Mobile/?rows=8&page=%d&userId=guowen&sort=create_date&order=desc&fk_bizId=c_gDoc&fk_id=48D2C7AF-2230-4CEA-92F6-E278EE45853B&sk=phiic",page)
