...
class showPeopleViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
   ...
   var spreadButton: SpreadButton!
    ...
    func AddreturnTopBtn()
    {
        ...
        returnTopBtn.frame=CGRect(x: 5, y:SCREEN_HEIGHT-210, width: 80, height: 30)
   ...
   //上拉加载
    ...
    func getData(page:Int)
    {
         ...
         let URLstring1=String(format: "http://10.10.10.201/doc/Main/ListDoc_Mobile/?rows=8&page=%d&userId=guowen&sort=create_date&order=desc&fk_bizId=c_gDoc&fk_id=8D3B8E11-BB13-4610-B27E-5EE91AE9115A&sk=phiic",page)
