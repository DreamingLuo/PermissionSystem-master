...
class showPeopleViewController2: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func getData(page:Int)
    {
        ...
        let URLstring1=String(format: "http://10.10.10.201/doc/Main/ListDoc_Mobile/?rows=8&page=%d&userId=guowen&sort=create_date&order=desc&fk_bizId=c_gDoc&fk_id=71EB5B5D-AF03-489D-A6D5-D55DF18B6421&sk=phiic",page)
