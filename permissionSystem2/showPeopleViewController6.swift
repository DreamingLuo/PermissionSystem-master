...
class showPeopleViewController6: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func getData(page:Int)
    {
        ...
        let URLstring1=String(format: "http://10.10.10.201/doc/Main/ListDoc_Mobile/?rows=8&page=%d&userId=guowen&sort=create_date&order=desc&fk_bizId=c_gDoc&fk_id=57212006-573C-4A4D-813D-4E1EE8CB580C&sk=phiic",page)
