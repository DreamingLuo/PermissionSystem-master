...
class DetailFileViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        let rightItem=UIBarButtonItem(image: img, style: UIBarButtonItemStyle.Plain, target: self, action: "search")
        
        
         let rightItem1=UIBarButtonItem(image: homeImage, style: UIBarButtonItemStyle.Plain, target: self, action: "returnHome")
    ...
    func  search()
    {
       ...
       let fileseachVc=fileSearchViewController()
        
        
        self.navigationController?.pushViewController(fileseachVc, animated: true)
    ...
    func AddreturnTopBtn()
    {
        ...
        returnTopBtn.frame=CGRect(x: 5, y:SCREEN_HEIGHT-60, width: 100, height: 50)
    ...
    func getData(page:Int)
    {
       ...
       // http://10.10.10.201/doc/Main/ListDoc_Mobile/?rows=8&page=0&userId=guowen&sort=create_date&order=desc&fk_bizId=c_gDoc&fk_id=D237A0BA-0895-43AC-8AD0-F61876A86C2B&pid=3c81df7b-45cc-4699-a941-19200d4ae504
        
        
       // http://10.10.10.201/doc/Main/ListDoc_Mobile/?rows=8&page=0&userId=guowen&sort=create_date&order=desc&fk_bizId=c_gDoc&fk_id=D237A0BA-0895-43AC-8AD0-F61876A86C2B&pid=1fa59ab5-110b-41ec-a850-b560d9b83b4d&sk=phiic
        ...
        let URLstring1=String(format: "http://10.10.10.201/doc/Main/ListDoc_Mobile/?rows=8&page=%d&userId=guowen&sort=create_date&order=desc&fk_bizId=c_gDoc&fk_id=D237A0BA-0895-43AC-8AD0-F61876A86C2B&pid=%@&sk=phiic",page,pid)
    ...
    //
    //    func getData1(url1:NSURL)
    //    {
    //        //访问网络
    //
    //        let jsonData=NSData(contentsOfURL: url1)
    //
    //
    //
    //
    ...
    //cell.updateTime.text=json["rows"][indexPath.row]["update_date"].stringValue
    
    //cell.updatePeople.text=json["rows"][indexPath.row]["update_byName"].stringValue
    
    
    //        let urlImg=NSURL(string: prefixUrl+json["rows"][indexPath.row]["imgUrl"].stringValue)
    //
    //
    //
    //        let  dataImage=NSData(contentsOfURL: urlImg!)
    ...
    //
    //
    //            cell.documentSize.text=json["rows"][indexPath.row]["size"].stringValue
    //
    //
    //
    //
    //            cell.documentName.text=json["rows"][indexPath.row]["name"].stringValue
    //
    //
    //
    //
    //            cell.uploadName.text=json["rows"][indexPath.row]["create_byName"].stringValue
    //
    //            cell.uploadName.textColor=UIColor.greenColor()
    //
    //            let uploadtime=json["rows"][indexPath.row]["create_date"].stringValue
    //
    //
    //            let ns2=(uploadtime as NSString).substringToIndex(10)
    //
    //
    //
    //
