...
class showPeopleViewController7: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func getData(page:Int)
    {
        ...
        let URLstring1=String(format: "http://10.10.10.201/doc/Main/ListDoc_Mobile/?rows=8&page=%d&userId=guowen&sort=create_date&order=desc&fk_bizId=c_gDoc&fk_id=5F4CE1C9-E55A-492C-AE69-77194268409F&sk=phiic",page)
